...
@TeleOp(name = "TeleOpRed", group = "StarterBot")
//@Disabled
public class TeleOpRed extends OpMode {
    ...
    private boolean skipColorSensor;
...
//        launcherL.setPIDFCoefficients(DcMotor.RunMode.RUN_USING_ENCODER, new PIDFCoefficients(300, 0, 0, 10));
    ...
    public void loop() {
        ...
        double yaw = detector.getAngleToRedTag();
        double dist = detector.distanceAssessFromRed();
        if (dist > 75.0) {
            ...
            if (gamepad1.left_bumper) {
                if(skipColorSensor) {
                    ...
                    for (int index = 0; index < 3; ) {
                        ColorDetector.detectedColor interestedColor = motifValues[colorIndex];
